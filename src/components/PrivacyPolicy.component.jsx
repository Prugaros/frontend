  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p>
        ...
        collected, used, and shared when you use our service.
      </p>
      ...
      <p>
        ...
        services. This includes using the information to:
        <ul>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            in accordance with any applicable law, regulation, or legal
            process;
          </li>
          <li>
            If we believe your actions are inconsistent with our user agreements
            or policies, or to protect the rights, property, and safety of our
            company or others.
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        logging into your online account or emailing us. If you wish to delete
        or deactivate your account, please email us, but note that we may
